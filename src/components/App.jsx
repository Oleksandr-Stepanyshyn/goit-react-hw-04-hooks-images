  ...
  componentDidUpdate (_, prevState) {
    ...
    if(prevQuery !== nextQuery || prevPage !== nextPage) {
        ...
        fetchImg(nextQuery, nextPage)
          .then(data => this.setState(({images}) => ({images: [...images, ...data.hits], totalImg: data.totalHits, isLoader: false})))
          .catch(error => {
            console.log(error)
  ...
  render() {
    ...
    return(
      <>
        ...
        {errorRequest && <ErrorText>No results found for "{searchQuery}" :(</ErrorText>}
      </>
    )
  }
};
